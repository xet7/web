angular.module(primaryApplicationName).controller('CtrlGeneratingKeys',
	function($rootScope, $scope, $state, $interval, $timeout, $translate, consts, crypto, user, co, signUp) {
